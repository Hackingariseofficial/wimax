...
setVariablesRequired(){
	...
	updateMaster=https://raw.githubusercontent.com/Hackingvisionofficial/wimax/wimax/wimax.sh
...
banner(){
	...
	$blue
	echo "---------------------    ****************************************************************    ----------------------"
	echo "|  [M] Main Menu    |    * Wimax /Laughingman / hackingvision.com ****************************************************************    ----------------------"
	$yellow
	echo "-------------------------------------------------------------------------------------------------------------------"
...
bannerNoMenu(){
	...
	$blue
	echo "---------------------    ****************************************************************    ----------------------"
	echo "|  [ CTRL+C ] Main  |    *WIMAX  /  Laughingman  /  github.com/Hackingvisionofficial *    | [CTRL+C x2 ] Exit  |"
	echo "---------------------    ****************************************************************    ----------------------"
	$yellow
	echo "-------------------------------------------------------------------------------------------------------------------"
	echo "| Interfaces: $interfacesFound  |  Interface Mode: $interfaceMode  |  [A] Advanced  |  Sessions: [S] Save  [L] Load  |  [E] Extras  [H] Help  |"
...
bannerExit(){
	...
	clear
	$blue
	echo "pussy for picking no ;)"
	echo ""
	echo "Laughingman"
	echo ""
	echo "https://hackingvision.com"
	$cyan
	echo "View are othere scripts On GitHub:"
	echo ""
	echo "https://github.com/Hackingvisionofficial"
	echo ""
	echo ""
